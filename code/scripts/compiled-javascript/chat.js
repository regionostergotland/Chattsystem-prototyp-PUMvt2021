 ...
 */
function addMessage(chatName, message, clientId = "", id = -1, sender = "", background = "", iconSource = "") {
 ...
 */
function addChatUserIcon(chatName, clientName, clientColor, clientIconSource, id) {
 ...
 */
function addInfoMessage(chatName, message) {
